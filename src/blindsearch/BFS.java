...
public class BFS {
	...
	/* this class applies the Breadth First Search to find a solution satisfying a Formula */ 
	
	private Formula formula;
	private int nb_vars;
	
	public BFS( String file , int nb_vars) throws IOException {
	...
	public void search () {
		...
		if ( solFound != null ) {
			System.out.println("      BFS Search finished");
			System.out.println("==============================");
			System.out.println("\nsorted sequence:");
			System.out.println(randomSequence);
			System.out.println("\nsolution found:");
